---
name: lexlint
description: Use when shipping an app that crawls the web, trains models, generates content, deploys a chatbot, or makes automated decisions, and you need to know which AI and scraping-law obligations apply in the jurisdictions it will operate in, before release
---

# LexLint

A lint for AI and scraping law. Like a code linter, it catches basic issues early,
it certifies nothing, and it replaces neither QA nor legal review.
